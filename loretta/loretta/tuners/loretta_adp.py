...
class Linear(nn.Linear, AdapterLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if tensorized:
            self.adapter_down = wrapped_linear_layers(in_features=in_features, out_features=bottleneck_size, tensorized=True, config=config_tensor_down)
            self.adapter_up = wrapped_linear_layers(in_features=bottleneck_size, out_features=out_features, tensorized=True, config=config_tensor_up)
        else:
